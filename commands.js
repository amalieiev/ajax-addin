...
var // The deferred used on DOM ready
    ...
    detach = function () {
        if (document.addEventListener) {
            ...
            removeEventListener("load", completed, false);
        } else {
...
jQuery.ready.promise = function (obj) {
    if (!readyList) {
        ...
        if (document.readyState === "complete") {
            ...
            // A fallback to onload, that will always work
            addEventListener("load", completed, false);
            ...
            try {
                top = frameElement == null && document.documentElement;
            } catch (e) {}
...
jQuery.support = (function () {
    ...
    jQuery(function () {
        ...
        // Use getComputedStyle because jsdom on node.js will break without it.
        if (getComputedStyle) {
            support.pixelPosition =
                (getComputedStyle(div, null) || {}).top !== "1%";
            support.boxSizingReliable =
                (getComputedStyle(div, null) || { width: "4px" }).width ===
                "4px";
...
jQuery.event = {
    ...
    special: {
        load: {
            // Prevent triggered image.load events from bubbling to load
            noBubble: true,
        },
        click: {
...
jQuery.each(
    {
        ...
        contents: function (elem) {
            return jQuery.nodeName(elem, "iframe")
                ? elem.contentDocument || elem.contentdocument
...
// NOTE: we've included the "window" in getComputedStyle
